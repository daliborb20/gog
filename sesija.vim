...
vmap ,su ! awk '{ print length(), $0 | "sort -n | cut -d\\  -f2-" }'
nnoremap ,d :call pdv#DocumentWithSnip()
nmap ,lr :e /opt/lamp/lin_php/cms/index.php
nnoremap <silent> ,pf :call PhpCsFixerFixFile()
nmap ,f :tag 
nmap ,  :nohlsearch
nmap ,es :tabedit ~/.vim/snippets/php.snippets
nmap ,ep :tabedit ~/.vim/plugins.vim
...
set ruler
set runtimepath=~/.vim,~/.vim/plugged/Vundle.vim/,~/.vim/plugged/vim-fugitive/,~/.vim/plugged/vim-vinegar/,~/.vim/plugged/ctrlp.vim/,~/.vim/plugged/nerdtree/,~/.vim/plugged/ag.vim/,~/.vim/plugged/greplace.vim/,~/.vim/plugged/vim-snipmate/,~/.vim/plugged/vim-surround/,~/.vim/plugged/php.vim/,~/.vim/plugged/vim-php-namespace/,~/.vim/plugged/supertab/,~/.vim/plugged/vim-addon-mw-utils/,~/.vim/plugged/tlib_vim/,~/.vim/plugged/vim-php-cs-fixer/,~/.vim/plugged/vmustache/,~/.vim/plugged/pdv/,~/.vim/plugged/ultisnips/,~/.vim/plugged/emmet-vim/,~/.vim/plugged/vim-airline/,~/.vim/plugged/auto-pairs/,~/.vim/plugged/nerdcommenter/,~/.vim/plugged/palenight.vim/,~/.vim/plugged/vim-css-color/,/var/lib/vim/addons,/usr/share/vim/vimfiles,/usr/share/vim/vim80,/usr/share/vim/vimfiles/after,/var/lib/vim/addons/after,~/.vim/after,~/.vim/plugged/vim-snipmate/after,~/.vim/plugged/ultisnips/after,~/.vim/plugged/vim-css-color/after,~/.vim/autload/plug.vim
set shiftwidth=4
set showmatch
set softtabstop=4
set splitbelow
...
silent only
cd /opt/lampp/htdocs/goog
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 index.php
badd +0 includes/css/style.css
argglobal
silent! argdel *
argadd index.php
edit index.php
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 59 - ((34 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
59
